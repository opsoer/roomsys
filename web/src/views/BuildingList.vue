  ...
  <div class="page-home">
      ...
      <div class="header-inner">
        ...
        <div class="header-actions">
          <template v-if="loggedIn">
            <el-tag v-if="role === 'super_admin'" size="small" type="danger">超级管理员</el-tag>
            <el-tag v-else-if="role === 'building_admin'" size="small" type="warning">管理员</el-tag>
            <span class="user-text">{{ username }}</span>
            <el-button v-if="role === 'super_admin'" size="small" @click="$router.push('/admin/buildings')">管理后台</el-button>
            <el-button v-else size="small" @click="$router.push('/landlord/rooms')">管理后台</el-button>
            <el-button size="small" @click="logout">退出</el-button>
          </template>
          <template v-else>
            <el-button size="small" plain @click="$router.push('/landlord/login')">房东登录</el-button>
            <el-button size="small" type="primary" @click="$router.push('/login')">平台管理</el-button>
          </template>
        </div>
      </div>
    </header>
    ...
    <section class="hero-section">
      ...
      <div class="hero-content">
        <h1 class="hero-title">邻租 · 深圳公寓</h1>
