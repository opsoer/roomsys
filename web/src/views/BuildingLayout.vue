    ...
    <div v-if="showMobileMenu" class="mobile-menu-overlay" @click="showMobileMenu = false">
      <div class="mobile-menu-panel" @click.stop>
        ...
        <el-menu :default-active="$route.path" router @select="showMobileMenu = false">
          <el-menu-item index="/landlord/rooms"><el-icon><HomeFilled /></el-icon>租房管理</el-menu-item>
          <el-menu-item v-if="isBuildingAdmin" index="/landlord/bills"><el-icon><Money /></el-icon>财务管理</el-menu-item>
          <el-menu-item v-if="isBuildingAdmin" index="/landlord/dividends"><el-icon><Coin /></el-icon>分红管理</el-menu-item>
          <el-menu-item v-if="isBuildingAdmin" index="/landlord/tasks"><el-icon><List /></el-icon>代办事项</el-menu-item>
          <el-menu-item v-if="isBuildingAdmin" index="/landlord/users"><el-icon><User /></el-icon>管理员管理</el-menu-item>
          <el-menu-item index="/landlord/settings"><el-icon><Setting /></el-icon>公寓设置</el-menu-item>
        </el-menu>
...
import { Menu, Close, List, Setting } from '@element-plus/icons-vue'
...
const isBuildingAdmin = computed(() => role.value === 'building_admin' || role.value === 'super_admin')
...
@media (max-width: 768px) {
  .layout-logo { font-size: 14px; margin-right: 12px; }
